...
class BookDetailsActivity : AppCompatActivity() {
    ...
    private fun setValuesToViews() {
        ...
        tvEmpAge.text = intent.getStringExtra("Year")
        tvEmpSalary.text = intent.getStringExtra("Title")

    }
    private fun deleteRecord(
        id: String
    ){
        val dbRef = FirebaseDatabase.getInstance().getReference("Employees").child(id)//dbname
    ...
    private fun openUpdateDialog(
        ...
        etEmpAge.setText(intent.getStringExtra("Year").toString())
        etEmpSalary.setText(intent.getStringExtra("Title").toString())
