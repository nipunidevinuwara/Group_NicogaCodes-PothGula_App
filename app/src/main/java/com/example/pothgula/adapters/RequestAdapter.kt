package com.example.pothgula.adapters
...
class RequestAdapter (private val requestList: ArrayList<EmployeeModel>) : RecyclerView.Adapter<RequestAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val currentEmp = requestList[position]
